...
const ApiDispatcher = (function () {
  ...
  function _getStandardRegistry() {
    return {
      ...
      "student_create_user": StudentCreateUserAction,
      "staff_onboard_teacher": StaffOnboardTeacherAction,
      "staff_create_teacher_user": StaffCreateTeacherUserAction,
      "staff_create_member_user": StaffCreateMemberUserAction,
      ...
      "staff_get_salary_configs": StaffGetSalaryConfigsAction,
      "staff_get_salary_config": StaffGetSalaryConfigAction,
      "staff_update_salary_config": StaffUpdateSalaryConfigAction,
      "staff_delete_salary_config": StaffDeleteSalaryConfigAction,
